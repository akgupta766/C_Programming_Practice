...
5. Write a program to generate the Fibonacci series up to n terms.
6. Write a program to find the nth Fibonacci number using recursion.
...
9. Write a program to reverse a given integer.
10. Write a program to swap two numbers without using a third variable.
11. Write a program to swap two numbers using bitwise XOR.
12. Write a program to find the GCD of two numbers.
13. Write a program to find the LCM of two numbers.
14. Write a program to check whether a given year is a leap year.
15. Write a program to find the sum of digits of a number.
16. Write a program to count the number of digits in a number.
17. Write a program to find the largest of three numbers.
18. Write a program to find the smallest of three numbers.
19. Write a program to convert a decimal number to binary.
20. Write a program to convert a binary number to decimal.
21. Write a program to convert a decimal number to octal and hexadecimal.
22. Write a program to check whether a number is positive, negative, or zero.
23. Write a program to check whether a number is even or odd without using the modulus operator.
24. Write a program to print all prime numbers between 1 and n.
25. Write a program to find the sum of the first n natural numbers.
26. Write a program to compute the power of a number using recursion.
27. Write a program to find the roots of a quadratic equation.
28. Write a program to calculate simple interest and compound interest.
...
34. Write a program to print Pascal's triangle.
...
40. Write a program to reverse an array in place.
41. Write a program to find the sum and average of elements in an array.
42. Write a program to count the number of even and odd elements in an array.
43. Write a program to find duplicate elements in an array.
44. Write a program to remove duplicate elements from an array.
45. Write a program to merge two sorted arrays.
46. Write a program to find the intersection of two arrays.
47. Write a program to find the union of two arrays.
48. Write a program to left rotate an array by d positions.
49. Write a program to right rotate an array by d positions.
50. Write a program to find the missing number in an array containing 1 to n.
51. Write a program to find the frequency of each element in an array.
52. Write a program to check if an array is sorted.
53. Write a program to find pairs in an array whose sum equals a given number.
54. Write a program to find the maximum subarray sum (Kadane's algorithm).
55. Write a program to move all zeros in an array to the end.
56. Write a program to segregate even and odd numbers in an array.
57. Write a program to find the equilibrium index of an array.
58. Write a program to find the majority element in an array.
59. Write a program to find the minimum and maximum in an array using a single traversal.
60. Write a program to find the leaders in an array (elements greater than all elements to their right).
61. Write a program to rearrange positive and negative numbers alternately in an array.
62. Write a program to find the length of the longest consecutive sequence in an array.
63. Write a program to find the k-th largest element in an array.
64. Write a program to merge two arrays into a third sorted array.
65. Write a program to find the difference between two arrays.
...
71. Write a program to find the transpose of a matrix.
72. Write a program to check whether a matrix is symmetric.
73. Write a program to find the sum of diagonal elements of a matrix.
74. Write a program to rotate a matrix by 90 degrees.
75. Write a program to print a matrix in spiral order.
76. Write a program to check whether two matrices are equal.
...
82. Write a program to count the number of words in a sentence.
83. Write a program to find the length of a string without using strlen().
84. Write a program to copy one string to another without using strcpy().
85. Write a program to concatenate two strings without using strcat().
86. Write a program to compare two strings without using strcmp().
87. Write a program to check whether two strings are anagrams of each other.
88. Write a program to remove all duplicate characters from a string.
89. Write a program to find the first non-repeating character in a string.
90. Write a program to count the occurrences of each character in a string.
91. Write a program to convert a string to uppercase without using library functions.
92. Write a program to convert a string to lowercase without using library functions.
93. Write a program to reverse the words in a sentence.
94. Write a program to check whether a string contains only digits.
95. Write a program to remove all white spaces from a string.
96. Write a program to find all substrings of a given string.
97. Write a program to find the longest palindromic substring in a string.
98. Write a program to implement strstr() (substring search).
99. Write a program to convert a string to an integer (implement atoi()).
100. Write a program to convert an integer to a string (implement itoa()).
101. Write a program to check whether a string is a rotation of another string.
102. Write a program to find the most frequent character in a string.
103. Write a program to remove a specific character from a string.
104. Write a program to replace all occurrences of a character in a string.
105. Write a program to toggle the case of each character in a string.
...
111. Write a program to demonstrate a function pointer used to call a function.
112. Write a program to find the length of a string using pointers.
113. Write a program to access array elements using pointers.
114. Write a program to demonstrate dynamic memory allocation using malloc() and free().
115. Write a program to demonstrate the use of calloc() and realloc().
116. Write a program to sort an array using pointers.
117. Write a program to demonstrate an array of pointers to strings.
118. Write a program to demonstrate a pointer to a structure.
...
124. Write a recursive program to find the sum of an array.
125. Write a recursive program for binary search.
126. Write a recursive program to find the power of a number.
127. Write a recursive program to solve the Tower of Hanoi problem.
128. Write a recursive program to find the GCD of two numbers.
...
134. Write a program to implement merge sort.
135. Write a program to implement quick sort.
136. Write a program to implement heap sort.
137. Write a program to implement counting sort.
138. Write a program to implement radix sort.
